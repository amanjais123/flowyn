...
useEffect(() => {
    if(open) {
        ...
        form.reset({
            variableName : defaultValues.variableName || "" ,          endpoint : defaultValues.endpoint || "" ,
        method: defaultValues.method || "GET",
        body : defaultValues.body || "",
        })
    }
                    ...
                    >
                        ...
                        render = {({field}) => (
                            <FormItem>
                                ...
                                <FormDescription>The HTTP method to use this request</FormDescription>
                                <FormMessage/>
                            </FormItem>
                        )}
                        />
